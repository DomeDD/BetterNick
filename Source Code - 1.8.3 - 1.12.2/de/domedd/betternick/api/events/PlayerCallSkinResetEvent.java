...
public class PlayerCallSkinResetEvent extends Event implements Cancellable {
	 ...
	 *
	 */
	public PlayerCallSkinResetEvent(Player player) {
		this.player = player;
		cancelled = false;
	}
	...
	public void resetSkin() {
		BetterNickAPI.getApi().resetPlayerSkin(player);
	}
